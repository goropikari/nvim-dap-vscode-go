...
wk.register({
  ...
  ["<leader>yr"] = {
    ...
    "osc52: copy file relative path",
  },
  ["<leader>ya"] = {
    function()
      require("osc52").copy(vim.fn.expand("%:p"))
    end,
    "osc52: copy file absolute path",
  },
  ["<leader>yf"] = {
    function()
      require("osc52").copy(vim.fn.expand("%:t"))
    end,
    "osc52: copy current file name",
  },
}, { mode = "n" })
wk.register({
...
wk.register({
  ["<leader>b"] = {
    ...
    c = {
      name = "[B]uffer [C]lear",
      c = {
        "<Cmd>BufferClose<CR><Cmd>q<CR>",
        "close buffer",
      },
      a = {
        "<Cmd>BufferCloseAllButCurrent<CR><C-w><C-o><CR>",
